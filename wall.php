            ...
            if ($viewedUserId !== $_SESSION['connected_id']) {
                ...
                if ($resultVerif->num_rows > 0) {
                    ...
                    echo '<form action="" method="post">
                            <input type="hidden" name="subscriber_id" value="' . $_SESSION['connected_id'] . '">
                            <input type="hidden" name="author_id" value="' . $viewedUserId . '">
                            <input type="submit" name="unsubscribe" value="Abonné">
                          </form>';

                    
                } else {
                    // L'utilisateur ne suit pas encore l'auteur, afficher le formulaire d'abonnement
                    ?>
                    <section>
                        <h3>S'abonner à <?php echo htmlspecialchars($user['alias'], ENT_QUOTES, 'UTF-8'); ?></h3>
